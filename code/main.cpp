...
int main(int argc, char const *argv[])
{
    ...
    std::string finfo = "N" + std::to_string(N) + "_imod" + std::string(argv[2]) + "_Ne" + std::string(argv[3]) + "_kar" + std::string(argv[4]) + "_lam" + std::string(argv[5]) + "_Kd" + std::string(argv[6]) + "_q" + std::string(argv[7]) + "_Cn" + std::string(argv[8]) + "_kard" + std::string(argv[9]) + "_lamd" + std::string(argv[10]);
    if (argc == 12)
    {
