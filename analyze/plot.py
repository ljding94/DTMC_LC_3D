...
def alpha_u_plot():
    ...
    # uz norm
    alpha_u = [1.4723108811252246, 1.5041477642870125, 1.4917032885592725, 1.452903089289555, 1.4079053024350594, 1.2838809156284545, 1.2616937264686248, 1.286026793720392, 1.201167754223943, 1.1713746818378825, 1.179985018426367, 1.1796708016489579, 1.05374140829622, 1.1316281497275797, 1.1489902037650463, 1.0977612630096436, 1.1029307965274928, 1.0954793387023247, 1.1320166475595055, 1.1146776358131572, 1.120967449783173]
    ...
    plt.plot(kcs,alpha_u,"s", linestyle="None",ms=5,mfc="None", label = "director alpha")
    plt.xlabel(r"$k_c$")
    plt.ylabel(r"$\alpha$")
    plt.legend()
    plt.show()
