...
def main():
    ...
    config_plot3D("../data/scratch_local/State_N100_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd3.0_q0.0_Cn3.0_ku0_therm.csv",mesh=1,rod=0,piwall=0,fnormal=0)
    O_MCstep_plot("../data/scratch_local/O_MC_N100_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd3.0_q0.0_Cn3.0_ku0.csv",Ne=2)
    config_plot3D("../data/scratch_local/State_N100_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd3.0_q0.0_Cn3.0_ku0.csv",mesh=1,rod=0,piwall=1,fnormal=0)
    #O_MCstep_plot("../data/Ne2/Dec3_2021/O_MC_N400_imod3_Ne2_lf0.0_kar100_C00.0_karg0.0_lam4.0_Kd4.0_q1.0_Cn4.0.csv",2)
    #config_plot3D("../data/scratch_local/State_N200_imod1_Ne2_lf0.0_kar20_C00.0_karg0.0_lam5.0_Kd3.0_q2.0_Cn3.0_ku100.csv",mesh=1,rod=0,piwall=1,fnormal=0)
    ...
    foldername = "../data/Ne2/Dec31_2021"
    ...
    qs = np.arange(0.3, 3.01, 0.3)
    q = 2.0
    Cns = [3.0, 4.0, 5.0, 7.0, 9.0, 11.0]
    Cn = 4.0
    kus = np.arange(0,10.1,1)
    pars = []
    pars1, pars2 = [], []
    for ku in kus[:]:
        Cn = Kd
