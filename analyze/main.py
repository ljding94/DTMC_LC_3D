...
def main():
    ...
    config_plot3D("../data/scratch_local/State_N200_imod1_Ne1_lf0.0_kar20_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0_g3.0_init.csv",mesh=1,rod=0,fnormal=0)
    config_plot3D("../data/scratch_local/State_N200_imod1_Ne1_lf0.0_kar20_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0_g3.0.csv",mesh=1,rod=0,fnormal=0)
    ...
    foldername = "../data/Ne2/Oct5_2021_1"
    ...
    par_dg = [0,0,0,1,0,1,1,1,1,1,1,1] # number of digit for each
    mod="lf"
    ...
    for i in range(len(pars)):
        ...
        for lf in lfs[::1]:
            if(i%1==0):
                pass
                filename = foldername + "/State_N%.0f_imod%.0f_Ne%.0f_lf%.1f_kar%.0f_karg%.1f_lam%.1f_Kd%.1f_q%.1f_Cn%.1f.csv" % (N, imod,Ne,lf,kar,karg,lam,Kd,q,Cn)
