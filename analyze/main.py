...
def main():
    ...
    #config_plot3D("../data/scratch_local/State_N100_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam3.0_Kd3.0_q3.0_Cn3.0_init.csv",mesh=1,rod=0,piwall=1,fnormal=0)
    config_plot3D("../data/scratch_local/State_N100_imod1_Ne2_lf0.0_kar5_C00.0_karg0.0_lam5.0_Kd3.0_q3.0_Cn3.0.csv",mesh=1,rod=0,piwall=1,fnormal=0)
