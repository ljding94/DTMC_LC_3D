...
def main():
    ...
    config_plot3D("../data/scratch_local/State_N200_imod3_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0_init.csv",mesh=1,rod=0,piwall=0,fnormal=0)
    ...
    config_plot3D("../data/scratch_local/State_N200_imod3_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0.csv",mesh=1,rod=0,piwall=0,fnormal=0)
    ...
    foldername = "../data/Ne2/Jan18_2022"
