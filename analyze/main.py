...
def main():
    ...
    #config_plot3D("../data/scratch_local/State_N100_imod3_Ne2_lf3.0_kar10_C00.0_karg0.0_lam5.0_Kd3.0_q3.0_Cn6.0.csv", mesh=1, rod=1, fnormal=0)
    config_plot3D("../data/scratch_local/State_N100_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam4.0_Kd6.0_q2.0_Cn9.0.csv",mesh=1,rod=1,fnormal=0)
    ...
    foldername = "../data/Ne2/Nov14_2021_1"
