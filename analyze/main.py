...
def main():
    ...
    #config_plot3D("../data/Ne2/May8_2021/State_N300_imod3_Ne2_kar100_lam12.0_Kd5.0_q0.0_Cn5.0_Cnp0.0_rCnp0.0.csv",mesh=1,rod=0)

    return 0

    #foldername = "../data/Ne2/Apr29_2021" # kinda switch to Ne2 simulation for next paper
    #foldername = "../data/Ne1/May4_2021" # mobius strip~,
    foldername = "../data/Ne2/May9_2021_1" # mobius strip~,
