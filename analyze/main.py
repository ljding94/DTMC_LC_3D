...
def main():
    ...
    #config_plot3D("../data/scratch_local/State_N200_imod1_Ne2_lf0.0_kar10_C00.0_karg0.0_lam5.0_Kd3.0_q2.0_Cn3.0_ku100.csv",mesh=1,rod=0,piwall=1,fnormal=0)
    ...
    foldername = "../data/Ne2/Dec30_2021"
    ...
    Cn = 4.0
    kus = np.arange(5,51,5)
    pars = []
    pars1, pars2 = [], []
    for q in qs[:]:
        Cn = Kd
        pars.append([N, imod, Ne, lf, kar, C0, karg, lam, Kd, q, Cn, kus])
