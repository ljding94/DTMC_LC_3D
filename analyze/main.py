...
def main():
    ...
    config_plot3D("../data/scratch_local/State_N198_imod4_Ne1_kar10_lam10.0_Kd0.0_q0.0_Cn0.0_Cnp0.0_rCnp0.0_init.csv",mesh=1)
    config_plot3D("../data/scratch_local/State_N198_imod4_Ne1_kar10_lam10.0_Kd0.0_q0.0_Cn0.0_Cnp0.0_rCnp0.0.csv",mesh=1)
