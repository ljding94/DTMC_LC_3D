...
def main():
    ...
    config_plot3D("../data/Ne2/Oct18_2021/State_N300_imod3_Ne2_lf10.0_kar40_C00.0_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0.csv",mesh=1,rod=0,fnormal=0,piwall=0,cvt_map="Mean",cmap_smooth=1)
    config_plot3D("../data/Ne2/Oct18_2021/State_N300_imod3_Ne2_lf15.0_kar40_C00.0_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0.csv",mesh=1,rod=0,fnormal=0,piwall=0,cvt_map="Mean",cmap_smooth=1)
    config_plot3D("../data/Ne2/Oct18_2021/State_N300_imod3_Ne2_lf20.0_kar40_C00.0_karg0.0_lam5.0_Kd0.0_q0.0_Cn0.0.csv",mesh=1,rod=0,fnormal=0,piwall=0,cvt_map="Mean",cmap_smooth=1)
    return 0

    foldername = "../data/Ne2/Oct29_2021"
