...
def main():
    ...
    foldername = "../data/Ne2/Mar23_2022"
    ...
    for i in range(len(pars)):
        ...
        O_stat_ana(foldername, pars[i], par_nm, par_dg, mode=mod, thermN=0000,CnequalsKc=0, tau_c=6)
        if 1:
            pass
