...
def main():
    ...
    if(len(sys.argv)>2):
        ...
        F_compot_param(folder="../data/pydata/local/Apr16_2023_params_test", m=0, alphas=np.arange(-0.81,0.81,0.05), gammas=np.arange(0.0,1.01,0.05),  bn_phi=100, bn_z=100, R=1)
        return 0
